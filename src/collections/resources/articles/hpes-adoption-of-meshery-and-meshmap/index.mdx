...
<a href="/case-study/HPE's_adoption_of_Meshery_and_Meshmap.pdf" download="HPE's_adoption_of_Meshery_and_Meshmap.pdf">
   <Button secondary title="Download Case Study" external={true}>
   </Button>
</a>
